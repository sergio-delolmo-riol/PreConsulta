...
VALUES 
('José', 'Celador González', '77788899Z', 'jose.celador@hospital.com', '666777888', '$2y$10$rJ5L5F5F5F5F5F5F5F5F5euZQX5F5F5F5F5F5F5F5F5F5F5F5F5F5u', NOW(), 'activo');
...
INSERT INTO Episodio_Urgencia (id_paciente, fecha_llegada, motivo_consulta, estado, id_prioridad)
VALUES 
...
VALUES 
(@celador_id, @episodio1, DATE_SUB(NOW(), INTERVAL 25 MINUTE), 'asignado'),
(@celador_id, @episodio2, DATE_SUB(NOW(), INTERVAL 55 MINUTE), 'asignado'),
(@celador_id, @episodio3, DATE_SUB(NOW(), INTERVAL 115 MINUTE), 'asignado');
